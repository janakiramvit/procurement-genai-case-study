...
// Extracted verbatim from the original app/page.tsx so both `/` and `/v1` render this
// exact same component -- one V1 UI, two routes, no duplicated logic. Behavior is
// byte-identical to before this extraction; only the file location moved.
...
export function V1ChatApp({ apiPath = "/api/chat" }: { apiPath?: string }) {
